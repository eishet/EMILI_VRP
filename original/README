...
./emili/"donde esta la instancia del problema.txt" "nombre problema definido en builder" "descripcion de algoritmo, sintax definida en builder" [-it|-ro time] [rnds seed] [ps]
